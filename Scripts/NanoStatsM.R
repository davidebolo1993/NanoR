...
#' @description NanoStatsM plots statistics for passed .fast5 files and returns 4 tables used by NanoCompare
#' @param NanoPrepareMList Object of class list returned by NanoPrepareM
#' @param NanoMTable Table returned by NanoTableM
#' @param DataOut Where NanoStatsM results will be saved. Use the same directory specified for NanoTableM function and be sure that it doesn't already contain NanoStatsM (or NanoStatsG) results
#' @return Plots: \cr 
