...
#' @param NanoPrepareGList Object of class list returned by NanoPrepareG function
...
#' @param Cores  Number of cores to be used: 1 by default. Does not affect time when dealing with .fastq and sequencing summary files.
